...
def modificarRegistro(archivo : str, campoID : str, campos : list, indice : int, titulo : str, seleccion : str, almacen : int = 0) -> None: 
                ...
                if type(campo) == list:
                    if len(campo) == 4: 
                        ...
                        if campo[1] == 'Utilidad.csv':
                            # print("Pruebas")
                            infoNueva[6] = int(infoActual[3]) * (1 +  (int(find(campo[1], campo[3], indiceDeOpcion)[1]) / 100))
